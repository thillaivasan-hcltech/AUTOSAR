...
static VAR(boolean, MOTORDRIVER_VAR) MotorDriver_Enabled = FALSE;
static VAR(motor_dir_t, MOTORDRIVER_VAR) MotorDriver_Dir = MOTOR_DIR_STOP;
static VAR(uint8, MOTORDRIVER_VAR) MotorDriver_PwmDuty = 0U;
